...
@pytest.mark.parametrize(
    ...
    [
        (
            "https://trustaiagency.com/",
            ["content", "duckduckgo", "google", "generate"],
            "png",
            32,
            32,
        ),
        ("https://trustaiagency.com/", ["generate"], "svg", 100, 100),
        ("https://trustaiagency.com/", ["duckduckgo"], "png", 32, 32),
        ("https://trustaiagency.com/", ["google"], "png", 256, 256),
        (
            "https://somerandometld.trustaiagency.com/",
            ["content", "duckduckgo", "google", "generate"],
            "svg",
            100,
            100,
